...
export const csrfToken = sessionId => createHmac('sha256', process.env.SESSION_CSRF_SECRET || 'elid-csrf-development-only').update(String(sessionId || '')).digest('base64url');
